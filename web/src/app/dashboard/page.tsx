      ...
      <div className="mb-10 flex items-end justify-between">
        ...
        {player?.handicap_index != null && (
          <div className="rounded-2xl border border-[#D4AF37]/30 bg-[#D4AF37]/8 px-6 py-4 text-center">
            ...
            <div className="mt-1 text-xs font-bold uppercase tracking-widest text-neutral-500">Handicap Index</div>
          </div>
        )}
      </div>
      ...
      {completedRounds.length > 0 && (
        <div className="mb-8 grid grid-cols-3 gap-4">
          {[
            ...
            <div key={s.label} className="rounded-xl border border-[#1c1c1c] bg-[#111111] p-5 text-center">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div className="min-w-0 flex-1">
                    ...
                    {f.matchId ? (
                      ...
                      <div className="text-xs text-neutral-600">Not on a round</div>
                    )}
                  </div>
          ...
          <div className="overflow-hidden rounded-2xl border border-[#1c1c1c]">
            ...
            <div className="grid grid-cols-[1fr_5rem_5rem_5rem_6rem] gap-4 border-b border-[#1c1c1c] bg-[#111111] px-5 py-3">
              {['Course', 'Holes', 'Gross', 'Pts', 'Status'].map(h => (
                <div key={h} className={`text-xs font-bold uppercase tracking-widest text-neutral-500 ${h !== 'Course' ? 'text-center' : ''}`}>{h}</div>
              ))}
            </div>
            {rounds.slice(0, 6).map((r, i) => (
              ...
              >
                ...
                <div className="text-center text-sm text-neutral-400">{r.holes_played}</div>
