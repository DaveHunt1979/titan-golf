...
const s = StyleSheet.create({
  ...
  field:              { gap: 8 },
  fieldLabel:         { fontSize: 10, fontFamily: FFB, color: '#fff', letterSpacing: 1.5 },
  fieldHint:          { fontFamily: FFB, letterSpacing: 0, color: '#fff' },
  ...
  currencyText:       { color: '#fff', fontSize: 15, fontFamily: FFB },
  ...
  toggleText:         { fontSize: 14, fontFamily: FFB, color: '#fff' },
  toggleTextActive:   { color: GOLD },
  toggleSub:          { fontSize: 10, fontFamily: FFB, color: '#fff', marginTop: 2 },
  ...
  sidePotTitle:       { fontSize: 14, fontFamily: FFB, color: '#fff', marginBottom: 2 },
  sidePotTitleActive: { color: GOLD },
  sidePotDesc:        { fontSize: 11, fontFamily: FFB, color: '#fff', lineHeight: 15 },
  ...
  onOffText:          { fontSize: 11, fontFamily: FFB, color: '#fff' },
  onOffTextActive:    { fontFamily: FFB, color: GOLD },

  slotLabel:          { fontSize: 10, fontFamily: FFB, color: '#fff', letterSpacing: 1 },
  sideFeeLabel:       { fontSize: 12, fontFamily: FFB, color: '#fff', flex: 1 },
  sideFeeInput:       { width: 80 },

  holePickLabel:      { fontSize: 10, fontFamily: FFB, color: '#fff', letterSpacing: 1 },
  ...
  holePillNum:        { fontSize: 15, fontFamily: FFB, color: '#fff' },
  holePillNumActive:  { color: GOLD },

  // Course picker modal
  pickerBtn:          { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' },
  pickerBtnText:      { color: '#fff', fontFamily: FFB, fontSize: 15, flex: 1 },
  pickerBtnPlaceholder: { color: '#444', fontFamily: FFB, fontSize: 15, flex: 1 },
  ...
  pickerClose:        { fontSize: 16, fontFamily: FFB, color: '#fff', paddingHorizontal: 8 },
  ...
  pickerEmpty:        { color: '#fff', fontFamily: FFB, textAlign: 'center', paddingVertical: 32, fontSize: 14 },
  pickerClear:        { alignItems: 'center', paddingVertical: 14, marginTop: 6 },
  pickerClearText:    { color: '#fff', fontFamily: FFB, fontSize: 14 },
});
