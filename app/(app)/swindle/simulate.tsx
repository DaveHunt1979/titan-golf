    ...
    <View style={[s.root, { backgroundColor: dc.bg }]}>
      ...
      <ScrollView contentContainerStyle={{ padding: 16, paddingBottom: 48 }}>
        <Text style={[s.sub, { color: dc.textSecondary }]}>
          Build and fully score a Swindle with a much bigger field than a real weekly game ever gets, to find where it breaks. Real society members first, synthetic fill for the rest.
        </Text>
