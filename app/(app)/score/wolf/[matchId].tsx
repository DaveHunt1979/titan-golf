...
const s = StyleSheet.create({
  ...
  pickTitle:       { fontSize: 14, fontFamily: FFB, color: '#fff', textAlign: 'center', marginBottom: 8 },
  ...
  pickOr:          { fontSize: 11, fontFamily: FFB, color: '#fff', textAlign: 'center' },
  ...
  partnerBtnTxt:   { fontSize: 16, fontFamily: FFB, color: '#fff' },
  ...
  changeBtnTxt:    { fontSize: 11, fontFamily: FFB, color: '#fff' },
