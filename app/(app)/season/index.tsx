...
function seasonRules(entry: MyEntry): { icon: keyof typeof Ionicons.glyphMap; title: string; body: string }[] {
  return [
    ...
    { icon: 'flash-outline', title: 'Performance Bonus', body: 'Score well and earn extra points on top of your Stableford total. 32 points nets +2, 36 nets +10, and any round of 41+ points earns the max +20 bonus. 31 points or fewer earns no bonus.' },
    { icon: 'flame-outline', title: 'Birdies, Eagles & More', body: 'Every hole you birdie is worth +5 bonus points, an eagle +10, and an albatross or better +20 — regardless of handicap. Card a hole-in-one and add another +10 on top of that.' },
    { icon: 'layers-outline', title: 'Divisions', body: 'A football-style league pyramid — Premier League down to League Two, seeded by handicap.' },
    { icon: 'stats-chart-outline', title: `Best ${entry.countingRoundLimit}`, body: `Play unlimited qualifying rounds. Only your best ${entry.countingRoundLimit} rounds — Stableford points plus any Performance and Birdie/Eagle bonuses — count toward your Season Points.` },
